...
class AutomatorWP_Groundhogg_User_Tag extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add tag to user', 'automatorwp-groundhogg' ),
            'select_option'     => __( 'Add <strong>tag</strong> to user', 'automatorwp-groundhogg' ),
            /* translators: %1$s: Tag. */
            'edit_label'        => sprintf( __( 'Add tag %1$s', 'automatorwp-groundhogg' ), '{tag}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( 'Add tag %1$s', 'automatorwp-groundhogg' ), '{tag}' ),
            'options'           => array(
                'tag' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'tag',
                    'option_default'    => __( 'Select a tag', 'automatorwp-groundhogg' ),
                    'name'              => __( 'Tag:', 'automatorwp-groundhogg' ),
                    'option_custom'         => true,
