...
class AutomatorWP_Groundhogg_Tag_Added extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'Tag added to user', 'automatorwp-groundhogg-integration' ),
            'select_option'     => __( '<strong>Tag</strong> added to user', 'automatorwp-groundhogg-integration' ),
            /* translators: %1$s: Tag. %2$s: Number of times. */
            'edit_label'        => sprintf( __( '%1$s added to user %2$s time(s)', 'automatorwp-groundhogg-integration' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( '%1$s added to user', 'automatorwp-groundhogg-integration' ), '{tag}' ),
            ...
            'options'           => array(
                'tag' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'tag',
                    'name'              => __( 'Tag:', 'automatorwp-groundhogg-integration' ),
                    'option_none_value' => 'any',
                    'option_none_label' => __( 'any tag', 'automatorwp-groundhogg-integration' ),
